...
export const CURRENT_HIKE_KEY = "current_hike";
export const HIKE_FETCH_SUCCESS = "hike-fetch-success";
export const PAST_HIKE_FETCH_SUCCCESS = "past-hike-fetch-success";
